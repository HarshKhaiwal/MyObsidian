...
You can organize notes in subdirectories and link them normally. For example, the links above all point to the `_notes/animals/cats.md` file. Here's another example: [[fitness]].

Non-latin languages are supported: [[2023-08-19]]; so are accents/diacritics: [[bon appétit!]]
